...
class LoopPlaybackEndEvent extends PlatformVideoEvent {
  LoopPlaybackEndEvent({
    required this.isLoopPlaybackEnd,
  });
  ...
  static LoopPlaybackEndEvent decode(Object result) {
    result as List<Object?>;
    return LoopPlaybackEndEvent(
      isLoopPlaybackEnd: result[0]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! LoopPlaybackEndEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(isLoopPlaybackEnd, other.isLoopPlaybackEnd);
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
    }    else if (value is LoopPlaybackEndEvent) {
      buffer.putUint8(135);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 135:
        return LoopPlaybackEndEvent.decode(readValue(buffer)!);
      case 136:
